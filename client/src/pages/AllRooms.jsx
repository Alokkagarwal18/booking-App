...
const AllRooms = () => {
  ...
  const handleFilterChange = (checked, value, type) => {
    setSelectedFilters((prevFilters) => {
      ...
      if (checked) {
        // Add value only if it's not already included
        ...
        {filteredRooms.map((room) => (
          ...
          >
            <img
              ...
              src={room.images[0]}
              alt="hotel-img"
              titl="View Room Details"
              className="w-full h-70 md:w-1/2 rounded-xl shadow-lg object-cover cursor-pointer"
            />
        ...
        >
          ...
          <div className="px-5 pt-5 pb-7">
            ...
            <button
              onClick={() => {
                clearFilters();
                setOpenFilters(false); // optional: auto-close filters on clear
              }}
              className="mt-4 px-4 py-2 text-sm border border-gray-400 rounded-md w-full hover:bg-gray-100 transition lg:hidden"
            >
              CLEAR FILTERS
            </button>
          </div>
