      ...
      <div className="py-28 md:py-35 px-4 md:px-16 lg:px-24 xl:px-32">
            ...
            {room?.images.length > 1 &&
              room.images.map((image, index) => (
                <img
                  ...
                  src={image}
                  alt="Room Image"
                  className={`w-full h-42 rounded-xl shadow-md object-cover cursor-pointer ${
        ...
        {/* checkin checkout form */}
        {
          <form
            ...
            className="flex flex-col md:flex-row items-start md:items-center justify-between bg-white shadow-[0px_0px_20px_rgba(0,0,0,0.15)] p-6 rounded-xl mt-6 md:mt-10"
          >
            <div className="flex flex-col md:flex-row items-start md:items-center md:gap-8 w-full md:w-auto">
              {/* Check-In */}
              ...
              <div className="flex flex-col w-full md:w-auto">
                ...
                <input
                  ...
                  type="number"
                  id="guests"
                  className="w-full max-w-[80px] rounded border border-gray-300 px-3 py-2 mt-1.5 outline-none"
                  required
                />
              </div>
            </div>
            ...
            <button
              type="submit"
              className="bg-primary hover:bg-primary-dull active:scale-95 transition-all text-white rounded-md w-full md:w-auto mt-4 md:mt-0 px-6 py-3 text-base cursor-pointer"
            >
          ...
          /* <form onSubmit={onSubmitHandler} className='flex flex-col md:flex-row items-start md:items-center justify-between bg-white shadow-[0px_0px_20px_rgba(0,0,0,0.15)] p-6 rounded-xl'>
              ...
              <div className='flex flex-col flex-wrap md:flex-row items-start md:items-center md:gap-10 text-gray-500'>
        ...
        <div className="max-w-3xl border-y border-gray-300 my-15 py-10 text-gray-500">
          <p>
            ...
            The Gusets will be allocated ground floor according to availability.
        ...
        <div className="flex flex-col items-start gap-4">
          <div className="flex gap-4">
            <img
              ...
              alt="Host"
              className="h-14 w-14 md:h-[72px] md:w-[72px] rounded-full object-cover"
            />
            <div>
        ...
        bg-primary-dull transition-all cursor-pointer"
          >
            Contact Now
          </button>
        </div>
